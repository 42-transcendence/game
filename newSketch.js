...
const attractiveBody1 = Bodies.circle(
	700,
	1200,
	50,
	{
...
const attractiveBody2 = Bodies.circle(
	300,
	650,
	50,
	{
...
Composite.add(world, [attractiveBody1, attractiveBody2]);
...
Events.on(runner, 'afterUpdate', (e) => {
	...
	//중력효과!
	attractive(attractiveBody1, circle, 0.2);
	attractive(attractiveBody2, circle, 0.2);
...
function attractive(attractiveBody, body, gravityConstant) {
	...
	Body.setVelocity(body, { x: body.velocity.x + force.x / 3, y: body.velocity.y + force.y / 3 })
}
